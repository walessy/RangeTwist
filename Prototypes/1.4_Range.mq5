...
//--- input parameters
input int      RangeSize = 25;  // Range in FX points (pips)
...
int OnInit()
{
   ...
   //--- set indicator name
   string short_name = "Range Difference (" + IntegerToString(RangeSize) + " points)";
                ...
                const int &spread[])
{
   ...
   for(int i = start; i < rates_total; i++)
   {
      ...
      RangeLineBuffer[i] = high[i - LineShift] + range;
   }
